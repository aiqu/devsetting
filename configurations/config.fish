...
setunion CPATH MY_INCLUDE_DIR
setunion LD_LIBRARY_PATH MY_LIBRARY_DIR
setunion LIBRARY_PATH MY_LIBRARY_DIR
setunion CMAKE_PREFIX_PATH MY_CMAKE_PREFIX_PATH
setunion PKG_CONFIG_PATH MY_PKG_CONFIG_DIR
setunion MANPATH MY_MANPATH
