...
source $HOME/$ENVFILE
if ! grep -q "devsetting" "$HOME/$ENVFILE" ;then
    echo '#auto generated by devsetting' >> $HOME/$ENVFILE
    echo 'export PATH=$HOME/.local/bin:$HOME/bin:$PATH' >> $HOME/$ENVFILE
    echo 'export TERM="xterm-256color"' >> $HOME/$ENVFILE
    echo 'alias ls="ls --color=auto"' >> $HOME/$ENVFILE
    echo 'alias ll="ls -alF --color=auto"' >> $HOME/$ENVFILE
    echo 'alias l="ls -l"' >> $HOME/$ENVFILE
fi
source $HOME/$ENVFILE
