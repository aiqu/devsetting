...
if [ $OS == 'centos' ];then
	...
	$SUDO apt install -y build-essential cmake git pkg-config libjpeg8-dev libtiff5-dev libjasper-dev libpng12-dev libavcodec-dev libavformat-dev libswscale-dev libv4l-dev libxvidcore-dev libx264-dev libgtk2.0-dev libatlas-base-dev fortran tesseract-ocr libtesseract-dev libleptonica-dev libatlas-dev libdc1394-22-dev
fi
