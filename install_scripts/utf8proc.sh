...
INSTALLED_VER_MAJOR=$(grep 'UTF8PROC_VERSION_MAJOR' $VERFILE 2>/dev/null | cut -d' ' -f3)
INSTALLED_VER_MINOR=$(grep 'UTF8PROC_VERSION_MINOR' $VERFILE 2>/dev/null | cut -d' ' -f3)
INSTALLED_VER_PATCH=$(grep 'UTF8PROC_VERSION_PATCH' $VERFILE 2>/dev/null | cut -d' ' -f3)
